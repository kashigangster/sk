...
print " %s============================%sKashi- Teach%s======================%s " % (C, B, C, N)

print " %sFB%s Group%s Hack %s11-09-2020%s (0:55)%s" % (W, B, R, C, Y, N)

print " %sDevelop by: %sKashi Teaches %s$$$%s S my love%s" % (W, R, W, Y, N)
print "                      %sAnd %sMy Mind%s" % (W, R, N)

print " %sCode: %sPython%s" % (W, C, N)

print " %sYoutube: %sKashi Teaches and Technical Zone %s" % (W, B, N)

print " %sWhtsapp: %s+923062045786 %s" % (W, B, N)
